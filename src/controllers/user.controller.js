...
const getWatchHistory = asyncHandler(async(req, res) => {
  const user = await User.aggregate([
    {
      $match: {
        // _id: req.user._id we cannot write these as in mongoose id is saved as string and when we directly pass the id it bydefault convert it to mongodb id but in aggregate pipeline it doesnot convert it bydefault 
